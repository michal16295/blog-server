...
module.exports.USER_LOGGED_IN = `User is logged in.`;
module.exports.USER_IDS_IDENTICAL = `User ids are identical.`;
module.exports.USER_ALREADY_EXISTS = `User already exists`;
module.exports.EMAIL_IS_TAKEN = `Email is taken`;
module.exports.USER_UPDATE_SUCCESS = `User updated successfully`;
module.exports.GROUP_NOT_FOUND = `Group not found`;
module.exports.USER_ALREADY_IN_THE_GROUP = `The user already in the group`;
module.exports.GRUOP_ALREDY_EXIST = `The user already has a groups with this name`;
